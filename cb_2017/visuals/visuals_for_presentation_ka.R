...
theme_plot <- theme(
  axis.text.y = element_text(colour="black", size = 16, family = "BPG Excelsior 2009"),
  axis.text.x = element_text(colour="black", size = 16, family="BPG Excelsior 2009"),
  axis.title.x = element_text(size=16, family = "BPG Excelsior Caps"),
  axis.title.y = element_text(size=16, family = "BPG Excelsior Caps"),
  strip.text  = element_text(size=16, family = "BPG Excelsior Caps"),
  panel.border = element_rect(fill=NA, linetype = "solid", colour = "black"),
  panel.background = element_rect(fill = NA),
  panel.grid.major = element_blank(),
  panel.grid.minor = element_blank(),
  plot.title = element_text(hjust = 0.5, colour = "Black", size=18, family = "BPG Excelsior Caps"),
  plot.subtitle = element_text(hjust = 0.5, colour = "Black", size=14, family = "BPG Excelsior Caps"),
  legend.title = element_text(size=12, family = "BPG Excelsior Caps"),
  legend.text = element_text(size=14, family = "BPG Excelsior 2009"),
  plot.caption = element_text(size=12, family = "BPG Excelsior 2009")
)
...
rand3$Cat <- revalue(rand3$Cat, c("Have equally close relations with both Unions"="ორივე კავშირთან თანაბრად ახლო\nურთიერთობების ქონა",
"DK/RA"="(არ ვიცი/უარი პასუხზე)" ,"Join the EEU"="გაწევრიანება ევრაზიულ ეკონომიკურ კავშირში,\nრომელსაც უძღვება რუსეთი",
"Not join any union"="(არცერთ კავშირში გაწევრიანება)",
"Join the EU"="გაწევრიანება ევროკავშირში,\nრომელსაც უძღვებიან დასავლეთ ევროპის ქვეყნები"))

rand3$Cat <- factor(rand3$Cat, levels=c("(არ ვიცი/უარი პასუხზე)", "(არცერთ კავშირში გაწევრიანება)",
			"ორივე კავშირთან თანაბრად ახლო\nურთიერთობების ქონა",  "გაწევრიანება ევროკავშირში,\nრომელსაც უძღვებიან დასავლეთ ევროპის ქვეყნები",
			"გაწევრიანება ევრაზიულ ეკონომიკურ კავშირში,\nრომელსაც უძღვება რუსეთი"))

rand3p <- ggplot(rand3, aes(x=Cat, y=Prop, fill=Cat))+
	geom_bar(stat="identity", position="stack")+
	labs(title="თქვენი აზრით, რა იქნებოდა საუკეთესო არჩევანი\nსაქართველოს მომავალი ეკონომიკური და\nპოლიტიკური განვითარებისთვის? (%)")+
...
ggsave("static/slide1.png", rand3p, height=7, width=13.5, dpi=300, device="png")
...
rand4$Cat <- revalue(rand4$Cat, c("Have equally close relations with both organizations"="ორივე ორგანიზაციასთან თანაბრად\nახლო ურთიერთობების ქონა",
"DK/RA"="(არ ვიცი/უარი პასუხზე)" ,"Join Collective Security Treaty Organization"="გაწევრიანება კოლექტიური უსაფრთხოების\nხელშეკრულების ორგანიზაციაში,\nრომელსაც უძღვება რუსეთი",
"Not join any organization "="(არცერთ ორგანიზაციაში გაწევრიანება)",
"Join NATO "="გაწევრიანება ნატოში,\nრომელსაც უძღვებიან\nდასავლეთ ევროპის ქვეყნები და აშშ"))

rand4$Cat <- factor(rand4$Cat, levels=c("(არ ვიცი/უარი პასუხზე)", "(არცერთ ორგანიზაციაში გაწევრიანება)",
			"ორივე ორგანიზაციასთან თანაბრად\nახლო ურთიერთობების ქონა",  "გაწევრიანება ნატოში,\nრომელსაც უძღვებიან\nდასავლეთ ევროპის ქვეყნები და აშშ",
			"გაწევრიანება კოლექტიური უსაფრთხოების\nხელშეკრულების ორგანიზაციაში,\nრომელსაც უძღვება რუსეთი"))

rand4p <- ggplot(rand4, aes(x=Cat, y=Prop, fill=Cat))+
  geom_bar(stat="identity", position="stack")+
  labs(x = "პასუხის ვარიანტი",
       
       title="თქვენი აზრით, რა იქნებოდა\nსაუკეთესო გადაწყვეტილება საქართველოსთვის\nსაკუთარი უსაფრთხოების უზრუნველყოფის მიზნით? (%)")+
 scale_fill_manual(name="კატეგორია",
  					values=c("#999999","#8da0cb","#a6d854","#fc8d62", "#66c2a5"))+
  scale_y_continuous(labels=function(x)x*100, limits=c(0, 1))+
  coord_flip(xlim=c(1, 5))+
...
ggsave("static/slide2.png", rand4p, height=7, width=13.5, dpi=300, device="png")
...
rand2_1 <- rand2[2:3, ]
rand2_2 <- rand2[4:5, ]
rand2_1$Strat <- c("საქართველო ნეიტრალური თუ იქნება,\nეს შეიძლება დაგვეხმაროს\nკონფლიქტების მოგვარებასა\nდა უსაფრთხოების გაძლიერებაში")
rand2_1$gr[rand2_1$Cat == "Somewhat agree: Neutrality could resolve conflicts"] <- c("გარკვეულწილად ვეთანხმები")
rand2_1$gr[rand2_1$Cat == "Strongly agree: Neutrality could resolve conflicts"] <- c("სრულად ვეთანხმები")

rand2_2$Strat <- c("რომელიმე ბლოკში გაწევრიანება\nმეტ სარგებელს მოუტანს საქართველოს")
rand2_2$gr[rand2_2$Cat == "Somewhat agree: Alignment with a block would bring more benefits"] <- c("გარკვეულწილად ვეთანხმები")
rand2_2$gr[rand2_2$Cat == "Strongly agree: Alignment with a block would bring more benefits"] <- c("სრულად ვეთანხმები")

rand2_dk$Strat <- c("(არ ვიცი/უარი პასუხზე)")
rand2_dk$gr <- c("(არ ვიცი/უარი პასუხზე)")
rand2_dk$Prop <- as.numeric(rand2_dk$Prop)
rand2_dk$LB <- as.numeric(rand2_dk$LB)
rand2_dk$UB <- as.numeric(rand2_dk$UB)

rand2_1$gr <- factor(rand2_1$gr, levels=c("სრულად ვეთანხმები", "გარკვეულწილად ვეთანხმები"))
rand2_2$gr <- factor(rand2_2$gr, levels=c("სრულად ვეთანხმები", "გარკვეულწილად ვეთანხმები"))
...
scale_fill_manual(name="პასუხის ვარიანტები",
					labels=c("არ ვიცი/უარი პასუხზე", "გარკვეულწილად ვეთანხმები", "სრულად ვეთანხმები"),
  ...
  geom_text(data=rand2_1,
	...
	geom_text(data=rand2_2,
			...
			position = position_stack(vjust=0.5),
            family="BPG Excelsior Caps")+
	labs(title="ამ ორი მოსაზრებიდან რომელს უფრო ეთანხმებით? (%)")+
...
ggsave("static/slide3.png", rand2p, height=7, width=13.5, dpi=300, device="png")
ggsave("static/slide3.svg", rand2p, height=7, width=13.5, dpi=300)
...
nato$Strat <- c("ნატოში?")
eu$Strat <- c("ევროკავშირში?")
eec$Strat <- c("ევრაზიულ ეკონომიკურ კავშირში?")
...
memb$Cat <- revalue(memb$Cat, c("Do not support at all"="საერთოდ არ ვუჭერ მხარს",
"DK/RA"="(არ ვიცი/უარი პასუხზე)" ,"Fully support"="სრულად ვუჭერ მხარს",
"Partially support, partially do not support"="ნაწილობრივ ვუჭერ მხარს, ნაწილობრივ – არა",
"Rather not support"="ძირითადად არ ვუჭერ მხარს","Rather support"="ძირითადად ვუჭერ მხარს"))

memb$Cat <- factor(memb$Cat, levels=c("(არ ვიცი/უარი პასუხზე)", "საერთოდ არ ვუჭერ მხარს", "ძირითადად არ ვუჭერ მხარს",  "ნაწილობრივ ვუჭერ მხარს, ნაწილობრივ – არა", "ძირითადად ვუჭერ მხარს", "სრულად ვუჭერ მხარს"))
...
ggsave("static/slide4.png", membp, height=7, width=13.5, dpi=300, device="png")
...
nato$Cat <- revalue(nato$Cat, c("Do not support"="არ ვუჭერ მხარს**", "In the middle"="ნაწილობრივ ვუჭერ მხარს, ნაწილობრივ – არა", "Support"="ვუჭერ მხარს*", "DK/RA"="(არ ვიცი/უარი პასუხზე)"))
...
slide5 <- ggplot(nato, aes(Year, Prop, group=Cat, label=Prop))+
  ...
  labs(title="საქართველოს გაწევრიანებას ნატოში: (%)",
		caption="\n* ,,სრულად ვუჭერ მხარს'' + ,,ძირითადად ვუჭერ მხარს''\n**,,საერთოდ არ ვუჭერ მხარს'' + ,,ძირითადად არ ვუჭერ მხარს''")+
  theme_plot+
  theme(
    plot.title = element_text(hjust = 0.5),
	plot.subtitle = element_text(hjust = 0.5),
...
ggsave("static/slide5.png", slide5, height=7, width=13.5, dpi=300, device="png")
...
eu$Cat <- revalue(eu$Cat, c("Do not support"="არ ვუჭერ მხარს**", "In the middle"="ნაწილობრივ ვუჭერ მხარს, ნაწილობრივ – არა", "Support"="ვუჭერ მხარს*", "DK/RA"="(არ ვიცი/უარი პასუხზე)"))
...
slide6 <- ggplot(eu, aes(Year, Prop, group=Cat, label=Prop))+
  ...
  scale_y_continuous(breaks=c(0.25, 0.50, 0.75, 1), labels=function(x)x*100)+
    scale_shape(guide="none")+
  guides(color = guide_legend(reverse=T))+
  labs(title="საქართველოს გაწევრიანებას ევროკავშირში: (%)",
		caption="\n* ,,სრულად ვუჭერ მხარს'' + ,,ძირითადად ვუჭერ მხარს''\n**,,საერთოდ არ ვუჭერ მხარს'' + ,,ძირითადად არ ვუჭერ მხარს''")+
  theme_plot+
  theme(
    plot.title = element_text(hjust = 0.5),
...
ggsave("static/slide6.png", slide6, height=7, width=13.5, dpi=300, device="png")
...
eec$Cat <- revalue(eec$Cat, c("Do not support"="არ ვუჭერ მხარს**", "In the middle"="ნაწილობრივ ვუჭერ მხარს, ნაწილობრივ – არა", "Support"="ვუჭერ მხარს*", "DK/RA"="(არ ვიცი/უარი პასუხზე)"))
...
slide7 <- ggplot(eec, aes(Year, Prop, group=Cat, label=Prop))+
  ...
  scale_y_continuous(breaks=c(0.25, 0.50, 0.75, 1), labels=function(x)x*100)+
    scale_shape(guide="none")+
	guides(color = guide_legend(reverse=T))+
  labs(title="საქართველოს გაწევრიანებას ევრაზიულ ეკონომიკურ კავშირში,\nრომელიც დაარსებულია რუსეთის ფედერაციის მიერ: (%)",
		caption="\n* ,,სრულად ვუჭერ მხარს'' + ,,ძირითადად ვუჭერ მხარს''\n**,,საერთოდ არ ვუჭერ მხარს'' + ,,ძირითადად არ ვუჭერ მხარს''\n***განმარტება იმის შესახებ, რომ ევრაზიული ეკონომიკური კავშირი დაარსებულია რუსეთის ფედერაციის მიერ, 2017 წლის ტალღაში დაემატა")+
  theme_plot+
  theme(
    plot.title = element_text(hjust = 0.5),
	plot.subtitle = element_text(hjust = 0.5),
...
ggsave("static/slide7.png", slide7, height=7, width=13.5, dpi=300, device="png")
...
alv$p25 <- revalue(alv$p25, c("Do not support"="არ ვუჭერ მხარს", "Neutral"="ნაწილობრივ ვუჭერ მხარს,\nნაწილობრივ – არა", "Support"="ვუჭერ მხარს", "DK/RA"="(არ ვიცი/უარი პასუხზე)"))

alv$p25 <- factor(alv$p25, levels=c("ვუჭერ მხარს", "ნაწილობრივ ვუჭერ მხარს,\nნაწილობრივ – არა", "არ ვუჭერ მხარს",  "(არ ვიცი/უარი პასუხზე)"))

alv$p28 <- revalue(alv$p28, c("Do not support"="არ ვუჭერ მხარს", "Neutral"="ნაწილობრივ ვუჭერ მხარს,\nნაწილობრივ – არა", "Support"="ვუჭერ მხარს", "DK/RA"="(არ ვიცი/უარი პასუხზე)"))

alv$p28 <- factor(alv$p28, levels=c("ვუჭერ მხარს", "ნაწილობრივ ვუჭერ მხარს,\nნაწილობრივ – არა", "არ ვუჭერ მხარს",  "(არ ვიცი/უარი პასუხზე)"))
...
alvp <- ggplot(alv,
  ...
  geom_label(stat = "stratum", label.strata = TRUE, 
             label.size=NA, family="BPG Excelsior 2009", size=4) +
...
ggsave("static/alluvial.png", alvp, height=7, width=13.5, dpi=300, device="png")
ggsave("static/alluvial.svg", alvp, height=7, width=13.5)
...
p241$Cat <- revalue(p241$Cat, c("DK/RA"="(არ ვიცი/უარი პასუხზე)",
"Other"="სხვა",
"It would result in improved safety in everyday life "="საქართველოს მოსახლეობის ყოველდღიური ცხოვრება\nუფრო უსაფრთხო იქნება",
"It would help strengthen our relations with the West"="ნატოში გაწევრიანება ხელს შეუწყობს საქართველოს\nურთიერთობის გაღრმავებას დასავლეთთან",
"Peoples economic conditions would improve"="გაუმჯობესდება საქართველოს მოსახლეობის\nეკონომიკური მდგომარეობა",
"My country would have a better chance to restore its territorial integrity"="გაიზრდება საქართველოს ტერიტორიული მთლიანობის\nაღდგენის შანსი",
"We would be better protected from foreign threats"="საქართველო მეტად იქნება დაცული\nსაგარეო საფრთხეებისგან"
))
...
slide11 <- ggplot(p241, aes(y=Prop, x=Cat,group=Strat,fill=Strat))+
  ...
  labs(x = "პასუხის ვარიანტი",
       ...
       title="გთხოვთ, მითხრათ მთავარი მიზეზი,\nთუ რატომ უჭერთ მხარს\nსაქართველოს გაწევრიანებას ნატოში? (%)",
	   subtitle="კითხვას უპასუხა 41%-მა,\nვინც ნატოში გაწევრიანების მომხრეა")+
  geom_text(data=p241,
            aes(x=Cat,y=Prop,label=ifelse(Prop > 0.015, sprintf("%0.f", round(Prop*100, digits = 0)), "")),
            position = position_stack(vjust=0.5),
            family="BPG Excelsior Caps")+
...
ggsave("static/slide11.png", slide11, height=7, width=13.5, dpi=300, device="png")
...
p271$Cat <- revalue(p271$Cat, c("DK/RA"="(არ ვიცი/უარი პასუხზე)",
"Other"="სხვა",
"EU countries would get to know better our culture and traditions"="ევროკავშირის ქვეყნები უკეთ გაიცნობენ\nსაქართველოს კულტურას და ტრადიციებს",
"I would be able to travel to the EU countries without a visa"="ვიზის გარეშე შევძლებ ევროკავშირის ქვეყნებში მოგზაურობას",
"It would result in improved safety in everyday life "="საქართველოს მოსახლეობის ყოველდღიური ცხოვრება\nუფრო უსაფრთხო იქნება",
"We would be better protected from foreign threats"="საქართველო მეტად იქნება დაცული\nსაგარეო საფრთხეებისგან",
"My country would have a better chance to restore its territorial integrity"="გაიზრდება საქართველოს\nტერიტორიული მთლიანობის აღდგენის შანსი",
"It would help strengthen our relations with the West"="ევროკავშირში გაწევრიანება ხელს შეუწყობს\nსაქართველოს ურთიერთობის გაღრმავებას დასავლეთთან",
"Peoples economic conditions would improve"="გაუმჯობესდება საქართველოს მოსახლეობის\nეკონომიკური მდგომარეობა"
))
...
slide12 <- ggplot(p271, aes(y=Prop, x=Cat,group=Strat,fill=Strat))+
  ...
  labs(x = "პასუხის ვარიანტი",
       ...
       title="გთხოვთ, მითხრათ მთავარი მიზეზი,\nთუ რატომ უჭერთ მხარს საქართველოს\nგაწევრიანებას ევროკავშირში? (%)",
	   subtitle="კითხვას უპასუხა 46%-მა,\nვინც ევროკავშირში გაწევრიანების მომხრეა")+
  geom_text(data=p271,
            aes(x=Cat,y=Prop,label=ifelse(Prop > 0.015, sprintf("%0.f", round(Prop*100, digits = 0)), "")),
            position = position_stack(vjust=0.5),
            family="BPG Excelsior Caps")+
...
ggsave("static/slide12.png", slide12, height=7, width=13.5, dpi=300, device="png")
...
p301$Cat <- revalue(p301$Cat, c("DK/RA"="(არ ვიცი/უარი პასუხზე)",
"Other"="სხვა",
"I would be able to travel to the EEU countries without a visa"="ვიზის გარეშე შევძლებ ევრაზიული კავშირის\nქვეყნებში მოგზაურობას",
"It would result in improved safety in everyday life "="საქართველოს მოსახლეობის ყოველდღიური ცხოვრება\nუფრო უსაფრთხო იქნება",
"We would be better protected from foreign threats"="საქართველო მეტად იქნება დაცული\nსაგარეო საფრთხეებისგან",
"My country would have a better chance to restore its territorial integrity"="გაიზრდება საქართველოს ტერიტორიული მთლიანობის\nაღდგენის შანსი",
"It would help strengthen our relations with Russia"="ევრაზიულ კავშირში გაწევრიანება ხელს შეუწყობს\nსაქართველოს ურთიერთობის გაღრმავებას რუსეთთან",
"Peoples economic conditions would improve"="გაუმჯობესდება საქართველოს მოსახლეობის\nეკონომიკური მდგომარეობა"
))
...
slide13 <- ggplot(p301, aes(y=Prop, x=Cat,group=Strat,fill=Strat))+
  ...
  labs(x = "პასუხის ვარიანტი",
       ...
       title="გთხოვთ, მითხრათ მთავარი მიზეზი,\nთუ რატომ უჭერთ მხარს საქართველოს\nგაწევრიანებას ევრაზიულ კავშირში?",
	   subtitle="კითხვას უპასუხა 19%-მა,\nვინც ევრაზიულ კავშირში გაწევრიანების მომხრეა")+
  geom_text(data=p301,
            aes(x=Cat,y=Prop,label=ifelse(Prop > 0.015, sprintf("%0.f", round(Prop*100, digits = 0)), "")),
            position = position_stack(vjust=0.5),
            family="BPG Excelsior Caps")+
...
ggsave("static/slide13.png", slide13, height=7, width=13.5, dpi=300, device="png")
...
p311$Cat <- revalue(p311$Cat, c("Don't know"="(არ ვიცი)",
"Refuse to answer"="(უარი პასუხზე)",
"Other"="სხვა",
"None"="(არცერთი)",
"Russia"="რუსეთი",
"Turkey"="თურქეთი",
...
slide14 <- ggplot(p311, aes(y=Prop, x=Cat,group=Strat,fill=Strat))+
  ...
  labs(x = "ქვეყანა",
       ...
       title="თქვენი აზრით, რომელი ქვეყანაა ამჟამად\nსაქართველოს მთავარი მეგობარი? (%)")+
  geom_text(data=p311,
            aes(x=Cat,y=Prop,label=ifelse(Prop > 0.015, sprintf("%0.f", round(Prop*100, digits = 0)), "")),
            position = position_stack(vjust=0.5),
            family="BPG Excelsior Caps")+
...
ggsave("static/slide14.png", slide14, height=7, width=13.5, dpi=300, device="png")
...
p321$Cat <- revalue(p321$Cat, c("Don't know"="(არ ვიცი)",
"Refuse to answer"="(უარი პასუხზე)",
"Other"="სხვა",
"None"="(არცერთი)",
"Russia"="რუსეთი",
...
ggsave("static/slide15.png", slide15, height=7, width=13.5, dpi=300, device="png")
...
margins1$predict <- revalue(margins1$predict, c("predict(pr outcome(3))"="მხარს ვუჭერ", "predict(pr outcome(2))"="ნეიტრალური", "predict(pr outcome(1))"="არ ვუჭერ მხარს"))
...
margins2$predict <- revalue(margins2$predict, c("predict(pr outcome(3))"="მხარს ვუჭერ", "predict(pr outcome(2))"="ნეიტრალური", "predict(pr outcome(1))"="არ ვუჭერ მხარს"))
...
margins3$predict <- revalue(margins3$predict, c("predict(pr outcome(3))"="მხარს ვუჭერ", "predict(pr outcome(2))"="ნეიტრალური", "predict(pr outcome(1))"="არ ვუჭერ მხარს"))
margins3$model <- c("ევრაზიული კავშირი")

models <- as.data.frame(rbind(margins1, margins2, margins3))
models$model <- factor(models$model, levels=c("ნატო", "ევროკავშირი", "ევრაზიული კავშირი"))
models <- subset(models, !predict %in% "ნეიტრალური")
models$at <- revalue(models$at, c("Male"="კაცი", "Female"="ქალი"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggsave("static/slide16.png", height=7, width=13.5, dpi=300, device="png")
...
ggsave("static/slide17.png", height=7, width=13.5, dpi=300, device="png")
...
models$model <- factor(models$model, levels=c("ნატო", "ევროკავშირი", "ევრაზიული კავშირი"))
models <- subset(models, !predict %in% "ნეიტრალური")
models$at <- revalue(models$at, c("1"="თბილისი", "2"="სხვა\nქალაქები", "3"="სოფლები"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggsave("static/slide18.png", height=7, width=13.5, dpi=300, device="png")
...
models$model <- factor(models$model, levels=c("ნატო", "ევროკავშირი", "ევრაზიული კავშირი"))
models <- subset(models, !predict %in% "ნეიტრალური")
models$at <- revalue(models$at, c("Georgian"="ქართველი", "Other"="სხვა"))
models$at <- factor(models$at, levels=c("Georgian"="ქართველი", "Other"="სხვა"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggsave("static/slide19.png", height=7, width=13.5, dpi=300, device="png")
...
models$at <- revalue(models$at, c("Secondary or lower"="საშუალო\nან დაბალი", "Vocational"="საშუალო\nტექნიკური", "Higher"="საშუალოზე\nმაღალი"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
ggplot(models, aes(x=at, y=margin, group=model, 
                   shape=predict, colour = predict))+
  geom_point(size=5)+
  ...
  scale_fill_manual(values=c("#377eb8", "#e41a1c", "#4daf4a"))+
  guides(fill = guide_legend(reverse=T))+
  labs(title="მიღებული განათლების დონე")+
  facet_grid(~model)+
  theme_plot+
  theme(
    legend.position="top",
...
ggsave("static/slide20.png", height=7, width=13.5, dpi=300, device="png")
...
models$at <- factor(models$at, levels=c("დიახ", "არა"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
ggplot(models, aes(x=at, y=margin, group=model, 
                   shape=predict, colour = predict))+
  geom_point(size=5)+
  ...
  scale_fill_manual(values=c("#377eb8", "#e41a1c", "#4daf4a"))+
  guides(fill = guide_legend(reverse=T))+
  labs(title="ჰქონდა თუ არა რესპონდენტის რომელიმე მშობელს უმაღლესი განათლება?")+
  facet_grid(~model)+
  theme_plot+
  theme(
    legend.position="top",
...
ggsave("static/slide21.png", height=7, width=13.5, dpi=300, device="png")
...
ggsave("static/slide22.png", height=7, width=13.5, dpi=300, device="png")
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  scale_fill_manual(values=c("#377eb8", "#e41a1c", "#4daf4a"))+
  guides(fill = guide_legend(reverse=T))+
  labs(title="ინტერნეტის მოხმარება სულ ცოტა თვეში ერთხელ")+
  facet_grid(~model)+
  theme_plot+
  theme(
    legend.position="top",
...
ggsave("static/slide23.png", height=7, width=13.5, dpi=300, device="png")
...
models$model <- factor(models$model, levels=c("ნატო", "ევროკავშირი", "ევრაზიული კავშირი"))
models <- subset(models, !predict %in% "ნეიტრალური")
models$at <- revalue(models$at, c("No"="არა", "Yes"="დიახ"))
models$at <- factor(models$at, levels=c("დიახ", "არა"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  scale_fill_manual(values=c("#377eb8", "#e41a1c", "#4daf4a"))+
  guides(fill = guide_legend(reverse=T))+
  labs(title="რელიგიურ მსახურებაზე დასწრება თვეში ერთხელ მაინც")+
  facet_grid(~model)+
  theme_plot+
  theme(
    legend.position="top",
...
ggsave("static/slide24.png", height=7, width=13.5, dpi=300, device="png")
...
models$model <- factor(models$model, levels=c("ნატო", "ევროკავშირი", "ევრაზიული კავშირი"))
models <- subset(models, !predict %in% "ნეიტრალური")
models$at <- revalue(models$at, c("Bad"="ცუდი",  "Neutral"="ნეიტრალური",  "Good_(3)"="კარგი"))
models$at <- factor(models$at, c("კარგი", "ნეიტრალური", "ცუდი"))
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  guides(fill = guide_legend(reverse=T))+
  facet_grid(~model)+
	labs(title="დამოკიდებულება იმიგრანტების მიმართ")+
  theme_plot+
  theme(
    legend.position="top",
	axis.title.y = element_blank(),
...
ggsave("static/slide25.png", height=7, width=13.5, dpi=300, device="png")
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  guides(fill = guide_legend(reverse=T))+
  facet_grid(~model)+
	labs(title="გაქვთ თუ არა ურთიერთობა\nსაქართველოში ჩამოსულ უცხოელებთან,\nვინც აქ 3 თვეზე მეტხანს იმყოფება?")+
  theme_plot+
  theme(
    legend.position="top",
	axis.title.y = element_blank(),
...
ggsave("static/slide26.png", height=7, width=13.5, dpi=300, device="png")
...
models$model <- factor(models$model, levels=c("ნატო", "ევროკავშირი", "ევრაზიული კავშირი"))
models <- subset(models, !predict %in% "ნეიტრალური")
models$at <- revalue(models$at, c("Wrong"="არასწორი", "Does not change at all"="არ იცვლება", "Right"="სწორი"))
models$at <- factor(models$at, levels=c("Right"="სწორი", "Does not change at all"="არ იცვლება", "Wrong"="არასწორი"))
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  guides(fill = guide_legend(reverse=T))+
  facet_grid(~model)+
  labs(title="საქართველოს საშინაო პოლიტიკის მიმართულება")+
  theme_plot+
  theme(
    legend.position="top",
	axis.title.y = element_blank(),
...
ggsave("static/slide27.png", height=7, width=13.5, dpi=300, device="png")
...
models$at <- revalue(models$at, c("Situation will never improve"="მდგომაროება\nვერასოდეს\nგამოსწორდება", "Everything will be fine"="ყველაფერი\nკარგად\nიქნება", "Agree with neither_(3)"="არცერთი"))

models <- subset(models, !at %in% "არცერთი")
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggsave("static/slide28.png", height=7, width=13.5, dpi=300, device="png")
...
models$at <- revalue(models$at, c("Disagree"="არ ვეთანხმები", "Agree"="ვეთანხმები", "Neither"="არცერთი"))
models$at <- factor(models$at, levels=c("ვეთანხმები", "არ ვეთანხმები", "არცერთი"))
models <- subset(models, !at %in% "არცერთი")
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  scale_fill_manual(values=c("#377eb8", "#e41a1c", "#4daf4a"))+
  guides(fill = guide_legend(reverse=T))+
  labs(title="საქართველოს დღევანდელი ხელისუფლება სამართლიანად ექცევა თქვენნაირ ადამიანებს")+
  facet_grid(~model)+
  theme_plot+
  theme(
    legend.position="top",
...
ggsave("static/slide29.png", height=7, width=13.5, dpi=300, device="png")
...
models$at <- revalue(models$at, c("People are like children"="მთავრობამ უნდა\nიზრუნოს ხალხზე", "Government is an employee"="ადამიანები უნდა\nაკონტროლებდნენ\nმთავრობას", "Agree with neither_(3)"="არცერთი"))
models <- subset(models, !at %in% "არცერთი")
models$predict <- factor(models$predict, c("მხარს ვუჭერ", "ნეიტრალური", "არ ვუჭერ მხარს"))
...
ggsave("static/slide30.png", height=7, width=13.5, dpi=300, device="png")
...
ggplot(models, aes(x=at, y=margin, group=model, 
  ...
  scale_fill_manual(values=c("#377eb8", "#e41a1c", "#4daf4a"))+
  guides(fill = guide_legend(reverse=T))+
  labs(title="მიიღეთ თუ არა მონაწილეობა 2016 წლის 8 ოქტომბრის საპარლამენტო არჩევნებში?")+
  facet_grid(~model)+
  theme_plot+
  theme(
    legend.position="top",
...
ggsave("static/slide31.png", height=7, width=13.5, dpi=300, device="png")
